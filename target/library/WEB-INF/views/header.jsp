...
<div class="row">
    <div class="col-md-4" role="navigation">
        <!-- <h1 style="font-size: 20px;margin-top: 9px">内大咸鱼</h1> -->
        ...
        <ul class="nav nav-pills">
            ...
            <li><a href="${pageContext.request.contextPath}/register">注册用户</a></li>
        </ul>
    </div>
    <div class="col-md-8">
    ...
    <nav class="navbar navbar-default" id="header-nav-middle">
        <div class="container-fluid">
            ...
            <div class="navbar-header">
                ...
                <a class="navbar-brand" href="${pageContext.request.contextPath}/main"><!-- <img alt="Brand" style="display: inline-block;" src="./image/tao.jpg" width="20" height="20"> --><span class="logo-word">图书馆管理系统</span></a>
            </div>
