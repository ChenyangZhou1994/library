...
<div class="templatemo-sidebar">
    ...
    <nav class="templatemo-left-nav">
        <ul>
            ...
            <li><a href="${pageContext.request.contextPath}/admin/books/show"><i class="fa fa-bar-chart fa-fw"></i>图书管理</a></li>
            <li><a href="${pageContext.request.contextPath}/admin/order/send"><i class="fa fa-users fa-fw"></i>借阅管理</a></li>
